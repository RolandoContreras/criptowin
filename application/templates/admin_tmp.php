...
<div class="page-container">
  ...
  <div class="page-sidebar">
		...
		<ul id="side-nav" class="main-menu navbar-collapse collapse">
			...
			<li class="has-sub active"><a href="icons-entypo.html"><i class="icon-thumbs-up"></i><span class="title">Icons</span></a>
				<ul class="nav">
					<li  class="active"><a href="icons-entypo.html"><span class="title">Entypo</span></a></li>
